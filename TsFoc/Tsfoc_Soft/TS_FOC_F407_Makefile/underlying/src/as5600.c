...
{
    as5600->Angle = 0.0f;
    as5600->Angle_old = 0.0f;
    as5600->Rotations = 0;
    as5600->Rotations_old = 0;
    as5600->Velocity = 0.0f;
    as5600->Velocity_old = 0.0f;
    as5600->angle_ts = 0;
    as5600->angle_ts_old = 0;
    as5600->Velocity_ts = 0;
    as5600->Velocity_ts_old = 0;
    as5600->i2c_handle = i2c_handle;
    printf("AS5600_Init: I2C handle initialized\r\n");
    return 0;
}
