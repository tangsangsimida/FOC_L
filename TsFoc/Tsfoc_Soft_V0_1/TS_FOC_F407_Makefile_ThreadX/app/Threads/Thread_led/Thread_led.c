...
TX_THREAD Thread_led;						//实例化线程句柄,线程相关信息
Thread_led_parama Thread_led_parama1;	//实例化入口函数的参数

/*******************************************************************************
* Function Name  : Thread_led_Entry
* Description    : Thread_led_Entry线程
...
{
  // Thread_led_parama *parama = (Thread_led_parama*)thread_input;	//获取入口函数的参数
